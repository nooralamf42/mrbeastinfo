...
import { Trophy, Award, Youtube } from 'lucide-react';
        ...
        >
          ...
          >
            <p className="text-lg md:text-xl leading-relaxed backdrop-blur-sm bg-black/20 p-6 rounded-lg">
              MrBeast is a one time Shorty Awards Winner. 🏆
            </p>

            <p className="text-lg md:text-xl leading-relaxed backdrop-blur-sm bg-black/20 p-6 rounded-lg">
              He won the award in 2020 at the 12th annual shorty awards. ⭐
            </p>

            <p className="text-lg md:text-xl leading-relaxed backdrop-blur-sm bg-black/20 p-6 rounded-lg">
              For Youtuber of the year 🎥
            </p>
          </motion.div>
          ...
          >
            ...
            <Link href={'https://www.youtube.com/watch?v=M3lTzluaVyE'} target="_blank">WATCH 🎥</Link>
            </RainbowButton>
          </motion.div>
          ...
          >
            {[
              ...
              { label: 'Award Year', value: '2020', icon: '📅' },
              { label: 'Category', value: 'YouTuber', icon: '🎥' },
            ].map((stat) => (
              <motion.div
                key={stat.label}
